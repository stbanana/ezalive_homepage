...
export default function HomeNewsSection({
    ...
    return (
        <section className="overflow-hidden rounded-2xl border border-fd-border bg-fd-card/90 p-6 shadow-md md:p-8">
